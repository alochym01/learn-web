...
func (a *AlbumMemory) FindAll() ([]domain.Album, error) {
	return a.al, nil
}

// FindByID locates the album whose ID value matches the id
// parameter sent by the client, then returns that album as a response.
func (a *AlbumMemory) FindByID(id string) (*domain.Album, error) {
...
func (a *AlbumMemory) Create(album domain.Album) error {
...
// parameter sent by the client, then returns that album as a response.
func (a *AlbumMemory) Update(temp domain.Album) error {
	// Loop over the list of albums, looking for
	// an album whose ID value matches the parameter.
...
// parameter sent by the client, then returns that album as a response.
func (a *AlbumMemory) Delete(id string) error {
	// Loop over the list of albums, looking for
	// an album whose ID value matches the parameter.
	for i, album := range a.al {
		if album.ID == id {
