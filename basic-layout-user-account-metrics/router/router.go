...
import (
	...
	"github.com/alochym01/learn-web/basic-layout-user-account/handler"
	"github.com/alochym01/learn-web/basic-layout-user-account/logger"
	"github.com/alochym01/learn-web/basic-layout-user-account/service"
	"github.com/alochym01/learn-web/basic-layout-user-account/storage"
...
func Router(db *sql.DB) *gin.Engine {
	...
	m := handler.Metrics{DB: db}
	router.GET("/metrics", m.Metric) // DELETE HTTP method with /albums/:id will be routed to deleteAlbumsByID function
